      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 -mt-24 relative z-10">
        ...
        >
          <div className="flex items-center justify-center mb-5">
            ...
            <p className="text-xs uppercase tracking-widest text-slate-600 font-light">Professional Development</p>
            <div className="h-px w-12 bg-slate-400/50 ml-4"></div>
          </div>
          <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed font-light">
            The Perrin Institute fosters meaningful connections between researchers, practitioners, and policymakers through carefully curated events and academic exchanges.
          </p>
        </motion.div>
      </div>
    </div>
