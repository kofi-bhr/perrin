...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-all duration-300 text-bg text-xl font-light border-b border-bg bg-fg overflow-clip`}
    >
      <div className="py-6 noise w-full h-full before:-z-10">
        <div className="mx-auto px-4 max-w-7xl z-30">
          <div className="flex justify-between items-center">
              ...
              <div className="hidden lg:flex items-center space-x-24 ml-auto">
                ...
                {isLoggedIn ? (
                  <button
                    ...
                    className={`px-4 py-2 text-nowrap bg-accent/75 text-bg hover:bg-accent transition-colors w-fit rounded-md`}
                  >
                    Sign Out
                  </button>
                ) : (
            ...
            <div className="flex lg:hidden ml-auto">
              <button
                className="text-bg focus:outline-hidden flex justify-center items-center"
